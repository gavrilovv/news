...
btNews.onclick = function (){
    ...
    <div class="profile-image">
        <img src="news-ikons/profile.png" alt="Изображение профиля">
    </div>
    ...
    <div class="block-post-top-right">
        <img src="news-ikons/procheePost.png" alt="Изображение прочее" class="prochee-image">
        <img src="news-ikons/citirovat.png" alt="Изображение цитировать" class="citirovat-image">
    </div>
...
<!--    </div>-->
    <div class="estimation">
        <div class="likes">
            <img src="news-ikons/likes.png" alt="Лайк" class="like">
            <p>0</p>
        </div>
        <div class="comments">
            <img src="news-ikons/chats.png" alt="Комментарий" class="comments">
            <p>0</p>
        </div>
        <div class="favourites">
            <img src="news-ikons/favorite.png" alt="Избранное" class="favorites">
        </div>
    </div>
    <p class="data"></p>
